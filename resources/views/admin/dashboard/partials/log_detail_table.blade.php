    ...
    <table class="w-full text-sm text-left text-gray-700 whitespace-normal table-auto">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-2 py-3">{{ $item->log->partModelRelation->frontView ?? '-' }}</td>
                <td class="px-2 py-3">{{ $item->station }}</td>
                <td class="px-2 py-3 break-words w-[10%]">
                    @if ($isImage)
                ...
                <td class="px-2 py-3 text-center">
                    ...
                    <span class="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800 font-medium">OK</span>
                    @elseif($item->prod_status == 'NG')
                    <span class="px-2 py-1 text-xs rounded-full bg-red-100 text-red-800 font-medium">NG</span>
                    @else
                    <span class="px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-800 font-medium">-</span>
                    @endif
                </td>
                <td class="px-2 py-3 text-center">
