                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        {{-- Ganti warna halaman aktif di sini, contoh: bg-blue-500 text-white --}}
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium bg-blue-500 text-white border border-blue-500 cursor-default leading-5">{{ $page }}</span>
                                    </span>
                                @else
